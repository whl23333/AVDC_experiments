...
do 
    CUDA_VISIBLE_DEVICES=$1 python benchmark_mw.py --env_name $task --n_exps 25 --ckpt_dir "../ckpts/AVDC" --milestone 9 --result_root "../results/AVDC"
done

python org_results_mw.py --results_root "../results/AVDC" 
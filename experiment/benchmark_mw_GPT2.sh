...
do 
    CUDA_VISIBLE_DEVICES=$1 python benchmark_mw_gpt2.py --env_name $task --n_exps 25 --ckpt_dir "../ckpts/gpt2_fs8_001" --milestone 9 --result_root "../results/gpt2_fs8_001"
done

python org_results_mw.py --results_root "../results/gpt2_fs8_001" 
...
do 
    CUDA_VISIBLE_DEVICES=$1 python benchmark_mw_gpt3.py --env_name $task --n_exps 25 --ckpt_dir "../ckpts/gpt3_fsVar_000" --milestone 8 --result_root "../results/gpt3_fsVar_000"
done

python org_results_mw.py --results_root "../results/gpt3_fsVar_000" 
...
do 
    CUDA_VISIBLE_DEVICES=$1 python benchmark_mw_gpt6.py --env_name $task --n_exps 25 --ckpt_dir "../ckpts/gpt6_fsVar_000" --milestone 9 --result_root "../results/gpt6_fsVar_000"
done

python org_results_mw.py --results_root "../results/gpt6_fsVar_000" 
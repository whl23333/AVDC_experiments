...
import json
import os
from flowdiffusion.inference_utils import get_video_model, pred_video, get_video_model_change, get_video_model_GPT, get_video_model_GPT2, get_video_model_GPT3, get_video_model_GPT6
import random
import torch
...
def run(args):
    ...
    video_model = get_video_model_GPT6(ckpts_dir=args.ckpt_dir, milestone=args.milestone)
